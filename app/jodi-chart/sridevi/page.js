// app/jodi-chart/sridevi/page.js

import { db } from '@/lib/firebase-admin';
import SrideviJodiChartClient from './SrideviJodiChartClient';
...
export default async function SrideviJodiChartPage() {
  // 1. Firebase se Sridevi Panna Chart ke saare weekly documents fetch karna
